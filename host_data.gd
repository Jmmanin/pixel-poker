...
func create_debug_deck() -> Array:
    var debug_deck = Array()

    debug_deck.append([6, 0]) # A1
    debug_deck.append([3, 0]) # B1
    debug_deck.append([0, 0]) # C1
    debug_deck.append([0, 1]) # D1
    debug_deck.append([6, 1]) # A2
    debug_deck.append([3, 1]) # B2
    debug_deck.append([5, 0]) # C2
    debug_deck.append([5, 1]) # D2
    debug_deck.append([0, 0]) # BURN
    debug_deck.append([8, 2]) # Flop1
    debug_deck.append([8, 3]) # Flop2
    debug_deck.append([7, 2]) # Flop3
    debug_deck.append([0, 0]) # BURN
    debug_deck.append([10, 3]) # Turn
    debug_deck.append([0, 0]) # BURN
    debug_deck.append([12, 0]) # River
...
func score_game():
    ...
    var winners = Array()
    for player in players_in_hand:
        print(str(player) + ' - ' + players[player].player_name)
        print(str(players[player].hand))
        print(str(players[player].hand_type))
        print('\n')
        if not winners:
